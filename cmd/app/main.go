...
func main() {
	...
	sensorGroup.DELETE("/reports/duration", sensorHandler.DeleteSensorReportByDuration)
	sensorGroup.DELETE("/reports/idandduration", sensorHandler.DeleteSensorReportByIDandDuration)
